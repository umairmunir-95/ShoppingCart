...
public partial class Pages_ShoppingCart : System.Web.UI.Page
{
    ...
    protected void btnCheckout_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sq.Close();
            clearCart();
            lblResult.Text = Session["id"].ToString();
            SendEmail();
    ...
    private void clearCart()
    {
        try
        {
            ...
            con.Open();
            string sql = @"delete from Cart where ClientID='" + Session["id"].ToString()+"'";
    ...
    private void SendEmail()
    {
        ...
        using (MailMessage mm = new MailMessage(from, to))
        {
            ...
            smtp.EnableSsl = true;
            NetworkCredential NetworkCred = new NetworkCredential(from, "password"); // password
